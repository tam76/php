<?php
// Chuẩn bị giá trị
$admin_function = 'Add User';
$custom_menu = array(
    'index.php?module=user&action=list' => 'Quản lý user'
);
require('templates/header_admin.php');
echo '
<form action="index.php?module=user&action=add" method="post" style="width: 650px;">
    ...
    <fieldset>
        ...
        <span class="form_item">
            ...
            <input type="radio" name="rdoLevel" value="2" checked="checked" /> Mod
        </span><br />
    </fieldset>
    <fieldset>
